...
public class Main09 {
    public static void main(String[] args) {
        Address09 address = new Address09("Mt. Hariyono", "Malang", "ID", "62701", "INDONESIA");
        address.validate();
        System.out.println("Alamat: " + address.outputAsLabel());

        Student09 student = new Student09("Abdul", "089372456748", "abdul@gmail.com", 12345, 75.5);
        ...
        System.out.println("Apakah mahasiswa layak mendaftar? " + student.isEligibleToEnroll());
        System.out.println("Seminars yang diambil: " + student.getSeminarTaken());

        Professor09 professor = new Professor09("Dr. Romi", "0898776576895", "romi@gmail.com", 85000);
